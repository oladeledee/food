...
(function ($) {
    ...
    var HDisplay = function HDisplay(element, options) {
    ...
    function Plugin(settings) {
        return this.each(function () {
            ...
            var options = $.extend({}, HDisplay.DEFAULTS, $this.data(), (typeof settings === 'undefined' ? 'undefined' : _typeof(settings)) === 'object' && settings);
